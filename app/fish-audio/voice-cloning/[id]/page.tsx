    ...
    <div className="max-w-5xl mx-auto px-6 py-10 font-sans">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-zinc-900">즉시 음성 복제</h1>
            <p className="text-sm text-zinc-500">오디오 10초만 필요합니다!</p>
          </div>
        </div>
        <button
          type="button"
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[110px] rounded-xl border border-zinc-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-zinc-900/10"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {tags.map(t => (
                        <button
                          ...
                          type="button"
                          onClick={() => removeTag(t)}
                          className="px-3 py-1 rounded-full bg-zinc-100 text-zinc-700 text-xs font-semibold hover:bg-zinc-200"
                        >
                          {t} ×
                        </button>
                      ))}
